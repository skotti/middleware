...
/home/azureuser/memtier_benchmark/install/bin/memtier_benchmark --port=$populate_port --protocol=memcache_text --ratio=1:0 --hide-histogram --expiry-range=99999-100000 --key-maximum=100 --server=$populate_server --test-time=$populate_time --clients=4 --threads=3 --data-size=$populate_size
